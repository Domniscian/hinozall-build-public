...
P1_TAIL_C = """"""
...
def apply_gz_patch(encoded: str, label: str) -> None:
    if label == "strict Ultra rebase":
        encoded = encoded + P1_TAIL_A + P1_TAIL_B + P1_TAIL_C
...
home_file = root / "app/src/main/java/com/domniscian/app/ui/screens/HomeScreen.kt"
home_text = home_file.read_text(encoding="utf-8")
if "import androidx.compose.runtime.saveable.rememberSaveable" not in home_text:
...
expected = {
    ...
    "app/src/main/java/com/domniscian/app/ui/screens/HomeScreen.kt": "676f8675051269d3a9999ea67b6b8e2513113440c35336518defaca10eabfd23",
